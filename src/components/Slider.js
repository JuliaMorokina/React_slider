...
class Slider extends React.Component {
    ...
    constructor(props) {
        ...
        // максимальное количество слайдов будет зависеть от длины массива slides
    ...
    // методы - действия, которые будет выполнять слайдер

    // componentDidMount срабатывает при появлении компонента на странице
    componentDidMount() {
        this.interval = setInterval(() => this.intervalBetweenSlides(), 3000);
    }

    // componentWillUnmount срабатывает при исчезновении компонента со страницы
